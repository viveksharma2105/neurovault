  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="relative pt-20 pb-16 md:pt-24 md:pb-32 px-4 sm:px-6 overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          {/* Glowing Orbs - Hidden on mobile for better performance */}
          <div className="hidden md:block absolute top-1/4 -left-48 w-96 h-96 bg-emerald-500/30 rounded-full mix-blend-screen filter blur-3xl animate-pulse-slow"></div>
          <div className="hidden md:block absolute top-1/3 -right-48 w-96 h-96 bg-violet-500/30 rounded-full mix-blend-screen filter blur-3xl animate-pulse-slow animation-delay-2000"></div>
          <div className="hidden md:block absolute bottom-1/4 left-1/2 w-96 h-96 bg-cyan-500/30 rounded-full mix-blend-screen filter blur-3xl animate-pulse-slow animation-delay-4000"></div>
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="text-center">
              ...
              {/* Main Heading */}
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold mb-4 md:mb-6 leading-tight px-2">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4 px-4">
                <button
                  onClick={openSignUp}
                  className="group relative w-full sm:w-auto px-6 md:px-8 py-3 md:py-4 text-base md:text-lg font-semibold rounded-xl bg-gradient-to-r from-emerald-500 to-cyan-500 text-white shadow-lg shadow-emerald-500/50 hover:shadow-emerald-500/70 hover:scale-105 transition-all duration-300"
                >
                ...
                <button
                  onClick={openSignIn}
                  className="w-full sm:w-auto px-6 md:px-8 py-3 md:py-4 text-base md:text-lg font-semibold rounded-xl bg-white/10 text-white backdrop-blur-sm border-2 border-white/20 hover:bg-white/20 hover:border-white/30 transition-all duration-300"
                >
                  Sign In →
                </button>
              </div>
              ...
              {/* Trust Indicators */}
              <div className="mt-8 md:mt-16 flex flex-wrap items-center justify-center gap-4 md:gap-8 text-slate-400 text-xs sm:text-sm px-4">
        ...
        <section className="py-12 md:py-20 px-4 sm:px-6 bg-slate-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 md:mb-4 bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900 bg-clip-text text-transparent">
                Everything you need
              </h2>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
              {/* Feature 1 */}
              <div className="group relative bg-white p-6 md:p-8 rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-300 border border-slate-200 hover:border-emerald-200 overflow-hidden">
              ...
              {/* Feature 2 */}
              <div className="group relative bg-white p-6 md:p-8 rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-300 border border-slate-200 hover:border-violet-200 overflow-hidden">
              ...
              {/* Feature 3 */}
              <div className="group relative bg-white p-6 md:p-8 rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-300 border border-slate-200 hover:border-cyan-200 overflow-hidden sm:col-span-2 md:col-span-1">
        ...
        {/* CTA Section */}
        <section className="relative py-16 md:py-24 px-4 sm:px-6 overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          {/* Background Effects */}
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mb-4 md:mb-6 px-4">
              Ready to organize your mind?
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-slate-300 mb-8 md:mb-10 max-w-2xl mx-auto px-4">
              Join thousands of creators, developers, and thinkers who trust NeuroVault every day.
            </p>
            <button
              onClick={openSignUp}
              className="group relative w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 text-base md:text-lg font-bold rounded-xl bg-gradient-to-r from-emerald-500 to-cyan-500 text-white shadow-2xl shadow-emerald-500/50 hover:shadow-emerald-500/70 hover:scale-105 transition-all duration-300 mx-4"
            >
            ...
            {/* Social Proof */}
            <div className="mt-8 md:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 text-slate-400">
